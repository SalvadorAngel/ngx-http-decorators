...
Шf most of your requests use the same host (base server url), then it can be specified using the `NGX_HTTP_DECORATORS_HOST_URL` InjectionToken as in the example below. 
